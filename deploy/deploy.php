 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', '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');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/LucasRi/weather-app.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/home/lucasdev/htdocs/weatherapp.lucasdesign.sk/');
...
if (!isset($_GET['sat']) || $_GET['sat'] !== SECRET_ACCESS_TOKEN || SECRET_ACCESS_TOKEN === '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') {
...
if (!is_dir(TMP_DIR)) {
	...
	$commands[] = sprintf(
		'git pull %s /home/lucasdev/htdocs/weatherapp.lucasdesign.sk/'
		, REMOTE_REPOSITORY
	);
} else {
